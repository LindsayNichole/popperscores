...
function popperscores_scripts()
{
	...
	wp_enqueue_style( 'popperscores-test-style', get_stylesheet_directory_uri().'/test.css' );
	wp_enqueue_style( 'popperscores-test2-style', get_stylesheet_directory_uri().'/css/test2.css' );

	wp_enqueue_script( 'popperscores-navigation', get_template_directory_uri() . '/js/testing.js', array(), '20151215', true );
